            ...
            <tbody>
                <c:forEach var="item" items="${items}">
                    <tr>
                        ...
                        <td>
                            <a href="<c:url value='/app/detail?id=${item.id}' />" class="btn btn-sm btn-secondary"><fmt:message key="app.view" /></a>
                            ...
                            <form method="POST" action="<c:url value='/app/delete' />" style="display:inline;">
                                ...
                                <fmt:message key="table.confirm_delete" var="confirmDelete" />
                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('${confirmDelete}')">
